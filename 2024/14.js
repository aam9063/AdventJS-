...
/**
 * Calcula el mínimo número de movimientos necesarios para que todos
 * los renos acaben en un establo, dado que no puede haber más de un reno
 * por establo.
 *
 * La forma de minimizar la distancia total es ordenar tanto las posiciones
 * de los renos como las de los establos, y emparejarlos en ese orden.
 *
 * @param {number[]} reindeer - Posiciones de los renos.
 * @param {number[]} stables - Posiciones de los establos.
 * @returns {number} - Suma mínima de movimientos.
 */
function minMovesToStables(reindeer, stables) {
  // 1. Ordenar ambos arreglos
  reindeer.sort((a, b) => a - b);
  stables.sort((a, b) => a - b);

  let totalMoves = 0;

  // 2. Emparejar cada reno con un establo según el índice
